...
posts = [
  %{
    ...
    content:
      "Phoenix LiveView enables rich, real-time user experiences with server-rendered HTML. Build interactive UIs with just Elixir.",
  ...
  %{
    ...
    content:
      "Use supervision trees and GenServers to build fault-tolerant systems. The actor model provides excellent concurrency.",
  ...
  %{
    ...
    content:
      "Use preloading to avoid N+1 queries. Select only needed fields and create proper database indexes.",
  ...
  %{
    ...
    content:
      "Test controllers, LiveViews, and business logic. Use factories for test data and property-based testing.",
  ...
  %{
    ...
    content:
      "Use Elixir releases for deployment. Configure environment variables and implement health checks.",
  ...
  %{
    ...
    content:
      "Processes are isolated, lightweight units. They communicate via message passing and can be monitored.",
  ...
  %{
    ...
    content:
      "Pattern matching is powerful for destructuring data and controlling program flow elegantly.",
  ...
  %{
    ...
    content:
      "GenServer provides standardized stateful processes. Handle calls, casts, and info messages.",
  ...
  %{
    ...
    content:
      "Use IEx, Logger, and Observer for debugging. Trace processes and measure performance.",
  ...
  %{
    ...
    content:
      "Streams provide lazy, composable enumerables. Perfect for large datasets and infinite sequences.",
  ...
  %{
    ...
    content:
      "Create reusable components with LiveView. Manage state and handle events efficiently.",
